...
export const filterAffairs = (affairs: AffairType[], filter: FilterType) => { // need to fix any
    const filtredAffairs:AffairType[] = affairs.filter(a => {
        if(filter === 'low') {
            return a.priority === 'low'
        } else if (filter === 'middle') {
            return a.priority === 'middle'
        } else if (filter === 'high') {
            return a.priority === 'high'
        } return true
    })

    return filtredAffairs // need to fix
}
export const deleteAffair = (affairs: AffairType[], _id: number): AffairType[] => { // need to fix any
    console.log(_id)
    const updatedAffairs: AffairType[] = affairs.filter(a => a._id !== _id)
